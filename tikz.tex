...
\input{sections/01_general_setup/general_setup.tex}
...
\begin{tikzpicture}
  ...
  % XY
  \node[canvas is xy plane at z=0] at ($(1,0)!0.5!(1,2)$)
       {canvas is xy plane};
  % XZ
  \node[canvas is xz plane at y=0] at ($(0,0,1)!0.5!(2,0,1)$)
       {canvas is xz plane};
  % YZ
  \node[canvas is yz plane at x=0] at ($(0,0,1)!0.5!(0,2,1)$)
       {canvas is yz plane};
  ...
\end{tikzpicture}
\end{lstlisting}
...
\begin{minipage}[c]{0.29\textwidth}
  \centering
  \includegraphics{sections/3d/standard/standard_canvas}
\end{minipage}

\subsubsection*{Custom Canvas}
...
\begin{tikzpicture}
  ...
  \begin{scope}[
    ...
    \draw[->, red  ] (0,0,0) -- (0,0.5,0);
    \draw[->, green] (0,0,0) -- (0.5,0,0);
  \end{scope}
  ...
\end{tikzpicture}
\end{lstlisting}
...
\begin{minipage}[c]{0.29\textwidth}
  \centering
  \includegraphics{sections/3d/custom_canvas/custom_canvas}
\end{minipage}

\newpage
\input{sections/positioning/positioning.tex}
